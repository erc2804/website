...
class PortfolioPage extends Component {
  render() {
    return (
      <Layout
        title="CasualVocab Privacy Policy"
        descriptionEn="Here you'll find the privacy policy of the CasualVocab app for iOS."
        descriptionDe="Hier finden Sie die Privacy Policy der CasualVocab App für iOS."
      >
        <div
          className={`${cvPrivacyStyles.cvPrivacyPageWrapper} default-padding`}
        >
          <div
            className={`${cvPrivacyStyles.headerTextContainer} font-header-4`}
          >
            CasualVocab Privacy Policy
          </div>
          <div className={cvPrivacyStyles.cvPrivacyContentWrapper}>
            <span className="font-body-1">
              Ercan Cicek built the CasualVocab Widget - Japanese app as a Free
              app. This SERVICE is provided by Ercan Cicek at no cost and is
              ...
              Conditions, which are accessible at CasualVocab Widget - Japanese
              ...
              <br />
              <br />
              <span className="font-subheading-1">Log Data</span>
              <br />
              <br />
              ...
              <br />
              <br />
              <span className="font-subheading-1">Cookies</span>
              <br />
              <br />
              ...
              <br />
              <br />
              <span className="font-subheading-1">Service Providers</span>
              <br />
              <br />I may employ third-party companies and individuals due to
              ...
              <br />
              <br />
              <span className="font-subheading-1">Security</span>
              <br />
              <br />
              ...
              <br />
              <br />
              <span className="font-subheading-1">Links to Other Sites</span>
              <br />
              <br />
              ...
              this page. This policy is effective as of 2022-06-22
              <br />
              <br />
              <br />
              <span className="font-subheading-1">Contact Me</span>
              <br />
              <br />
